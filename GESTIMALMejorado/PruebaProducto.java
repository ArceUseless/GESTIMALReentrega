  ...
  public static void main( String[] args ){
    ...
    do {
      ...
      case 1:
        ...
        break;
      /*
       * case 2: //Mostrar producto System.out.println(
       * "\n======MOSTRAR PRODUCTO======" );
       * 
       * try { System.out.println( "Introduzca el código del producto." ); codigo =
       * Teclado.tecladoInt(); if(almacen.devolverArticulo(codigo ) == null) {
       * System.out.println( "Producto no encontrado." ); }else { System.out.println(
       * almacen.devolverArticulo( codigo ) ); } } catch ( NumberFormatException e ) {
       * System.out.println( "ERROR: Formato numérico incorrecto." ); } catch
       * (ArrayIndexOutOfBoundsException i) { System.out.println(
       * "ERROR: Codigo incorrecto." ); } catch ( InputMismatchException ime) {
       * System.out.println( "ERROR: Error en la entrada de datos." ); } break;
       */
      case 2:
        // Alta
      ...
      case 5:
        ...
        try {
          ...
          almacen.almacen.get(indice)
              .incrementarExistencias(Teclado.tecladoInt("Introduzca la cantidad que desea sumar al stock"));
      ...
      case 6:
        ...
        try {
          indice = almacen.devolverIndice(Teclado.tecladoInt("Introduzca el código del producto"));
          almacen.almacen.get(indice)
              .reducirExistencias(Teclado.tecladoInt("Introduzca la cantidad que desea restar al stock"));
          System.out.println("Stock actualizado");
        } catch (Exception e) {
          System.out.println("ERROR: entrada incorrecta.");
        }
